...
* $c->pg_connect.
*/
//$c->pg_connect[] = "host=db port=5432 dbname=davical user=davical";
$c->pg_connect[] = "host=db port=5432 dbname=davical user=davical password=davical";
...
*/
$c->default_privileges = array('read-free-busy', 'schedule-query-freebusy', 'schedule-deliver-invite', 'schedule-deliver-reply');
...
$c->authenticate_hook['call'] = 'LDAP_check';
$c->authenticate_hook['config'] = array(
    'host'              => 'ldap://ldap.cobblepot59.int',
    'bindDN'            => 'calendar@cobblepot59.int',
    'passDN'            => 'calendar',
    'baseDNUsers'       => 'OU=Domain Users,DC=cobblepot59,DC=int',
    'protocolVersion'   => 3,
    'optReferrals'      => 0,
    'networkTimeout'    => 10,
